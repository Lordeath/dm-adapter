...
public final class AdapterWorkspaceResolver {
    ...
    public AdapterWorkspaceResolver() {
    ...
    public Path resolve(Path projectRoot, Path appModule, Path configuredReportDir) {
